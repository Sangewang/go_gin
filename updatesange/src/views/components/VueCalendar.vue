<template>
	<div id="calendar">
		...
		<ul class="days">
			...
			<li v-for="dayobject in days" :key="dayobject.day.getTime()">
				<!--本月-->
				<!--如果不是本月  改变类名加灰色-->
...
export default {
	...
	methods: {
		initData: function(cur) {
			...
			//其他周
			for (var tmpi = 1; tmpi <= 35 - this.currentWeek; tmpi++) {
				var tmpd = new Date(str);
				tmpd.setDate(tmpd.getDate() + tmpi);
				var newdayobject = {};
				newdayobject.day = tmpd;
				this.days.push(newdayobject);
			}
		},
