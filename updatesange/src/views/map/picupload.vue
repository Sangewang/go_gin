...
<script>
import { PicUpload } from '../../api/upload.js'
import { PicDownload } from '../../api/upload.js'
// import blobToFormData from '../../utils/formdata.js';
export default {
	data() {
		return {
			labelPosition: 'left',
	...
	methods: {
		submitUpload() {			
			PicUpload(this.sendfileList).then(response => {
